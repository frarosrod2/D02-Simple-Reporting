...
<acme:form>
	...
	<acme:form-textbox code="anonymous.technologyRecord.form.label.inventor" path="invenntor"/>
	...
	<acme:form-textbox code="anonymous.technologRecord.form.label.stars" path="stars"/>
